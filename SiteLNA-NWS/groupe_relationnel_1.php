...
<html>
	<head>
		...
		<title>Groupe relationnel 1 - Les Nouveaux Arrivants</title>
	</head>
	<body>
			...
			<div class="pamais">
				...
				<div class="div2amais">
					<div class="div9cadre div10cadre taille">
						...
						2/3/4 = Envoyer dans le groupe relationnel 2/3/4
					</div>
					<?php 
						if($relations == 1)
						{
					...
					<div class="div9cadre div10cadre div11cadre">
						<form method="post" action="groupe_relationnel_1.php" class="form">
							<?php
