...
WHERE pro.id_demandeur = ? AND de.date > ? AND pro.valeur_proposition = ? ORDER BY date');
...
WHERE pro.id_demandeur = ? AND de.date > ? AND pro.valeur_proposition = ?');
...
<html>
	<head>
		...
		<title>Liste des propositions des utilisateurs - Les Nouveaux Arrivants</title>
	</head>
	<body>
			...
			<div class="pamais">
				...
				<div class="div2amais">
					<div class="div9cadre div10cadre">
						<h2>Liste des propositions des utilisateurs</h2>
					</div>
						<?php 
							if($m >= $limite)
							{
						...
						?>
					<div class="div9cadre div10cadre">
						<form method="post" action="liste_propositions_utilisateurs.php" class="form">
						<?php
