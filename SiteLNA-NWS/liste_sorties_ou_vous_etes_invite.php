...
$req3->execute(array($_SESSION['id'], $_SESSION['id'], 2));
$donnees3 = $req3->fetch();
$nbrsortie = 0;
...
<html>
	<head>
		...
		<title>Liste des sorties où vous êtes invité - Les Nouveaux Arrivants</title>
	</head>
	<body>
			...
			<div class="pamais">
				...
				<div class="div2amais">
					<div class="div9cadre div10cadre">
						<h2>Liste des sorties où vous êtes invité</h2>
							...
							if($n >= 1)
							{
								for($i = $limite; $i <= $m; $i++)
								{
									...
									echo "<div class='div9cadre div10cadre'><form method='post' action='traitementlistedessorties.php' class='form'>
										...
										<input type='submit' name='valider2' value='Afficher la sortie' class='boutonamais'/>
										</form></div>";
								}
							}else
							{
						...
						?>
					<div class="div9cadre div10cadre">
						<form method="post" action="liste_sorties_ou_vous_etes_invite.php" class="form">
						<?php
