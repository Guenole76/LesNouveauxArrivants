...
<html>
	<head>
		...
		<title>Inviter-groupe relationnel Pro - Les Nouveaux Arrivants</title>
	</head>
	<body>
			...
			<div class="pamais">
				...
				<div class="div2amais">
					<div class="div9cadre div10cadre taille">
						<h2>Inviter le groupe relationnel Pro</h2>
						<h3>Les Prosches ♦</h3>
						<form method="post" action="traitementinviter_gr.php" class="form">
							<?php
								if($limitation == 1)
								{
									echo '<input type="submit" name="ithomme2" value="Inviter tous les hommes" class="boutonoptioninvit"/>
										<input type="submit" name="itfemme2" value="Inviter toutes les femmes" class="boutonoptioninvit"/><br/>
										<input type="submit" name="itlieu2" value="Inviter tous les lieux" class="boutonoptioninvit"/>';
								}
							?>
							<div class="div2_gr">
							...
							if($limitation == 0)
							{
								for($i = $o; $i <= $n; $i++)
								{
									if(isset($id_membre[$i]))
									{
										...
										<input type='hidden' name='invitation' value=6 />
					...
					<div class="div9cadre div10cadre div11cadre">
						<form method="post" action="inviter_gr_pro.php" class="form">
							<?php
