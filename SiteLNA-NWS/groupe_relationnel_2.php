...
if(isset($_POST['page']))
{
	$_SESSION['page_gr2'] = $_POST['page'];
}
if(!isset($_SESSION['page_gr2']))
{
	$_SESSION['page_gr2'] = 1; 
}
$limite = ($_SESSION['page_gr2'] - 1) * 40;
$_SESSION['gr'] = 2;
...
<html>
	<head>
		...
		<title>Groupe relationnel 2 - Les Nouveaux Arrivants</title>
	</head>
	<body>
			...
			<div class="pamais">
				...
				<div class="div2amais">
					<div class="div9cadre div10cadre taille">
						...
						<form method="post" action="traitement_gr.php" class="form">
							<div class="div2_gr">
								...
								<input type="text" name="surnom3" placeholder="Surnom Perso" maxlength=100 class="input_gr"/><br/>
						...
						1/3/4 = Envoyer dans le groupe relationnel 1/3/4
					</div>
					<?php 
						if($relations == 1)
						{
							...
							}elseif($limitation == 1)
							{
								for($i = $o; $i <= $n; $i++)
								{
									if(isset($id_membre[$i]))
									{
										...
										<input type='submit' name='groupe_relationnel' value='1' class='boutonnom'/>
										<input type='submit' name='groupe_relationnel' value='3' class='boutonnom'/>
										<input type='submit' name='groupe_relationnel' value='4' class='boutonnom'/><br/>
										<label>Sympathie le " .$t_s. "</label>
										</form></div>";
									}
					...
					<div class="div9cadre div10cadre div11cadre">
						<form method="post" action="groupe_relationnel_2.php" class="form">
							<?php
