...
if(isset($_POST['page']))
{
	$_SESSION['page_gr4'] = $_POST['page'];
}
if(!isset($_SESSION['page_gr4']))
{
	$_SESSION['page_gr4'] = 1; 
}
$limite = ($_SESSION['page_gr4'] - 1) * 40;
$_SESSION['gr'] = 4;
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						...
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
						$req3->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees3 = $req3->fetch();
					}
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						...
						}else
						{
							$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
							FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
							WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
							$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
							$donnees2 = $req2->fetch();
							$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
							FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY rel.id_relation LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY ins.mdn DESC, ins.jdn DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY ins.mdn DESC, ins.jdn DESC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY ins.mdn ASC, ins.jdn ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie DESC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			if($_SESSION['lieu_gr'] == 0)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
			...
			}elseif($_SESSION['lieu_gr'] == 1)
			{
				if(!preg_match("#^[ ]*$#", $_SESSION['surnom2_gr']))
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom2 LIKE "%' .$_SESSION['surnom2_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
				...
				}else
				{
					if(!preg_match("#^[ ]*$#", $_SESSION['surnom1_gr']))
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? AND ins.surnom1 LIKE "%' .$_SESSION['surnom1_gr']. '%" ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
					...
					}else
					{
						$req2 = $bdd->prepare('SELECT ins.surnom1 s1, ins.surnom2 s2, ins.jdn jdn, ins.mdn mdn, ins.l l, ins.nom_l nom_l
						FROM inscrits AS ins LEFT JOIN relations AS rel ON ins.id = rel.id_membre_2
						WHERE rel.id_membre_1 = ? AND rel.groupe_relationnel = ? AND ins.valeur_inscrit BETWEEN 1 AND 2 AND rel.points_de_relation BETWEEN 0 AND 100 AND ins.l = ? ORDER BY ins.mdn ASC, ins.jdn ASC, rel.t_sympathie ASC LIMIT ' .$limite. ', 40');
						$req2->execute(array($_SESSION['id'], $_SESSION['gr'], $_SESSION['lieu_gr']));
						$donnees2 = $req2->fetch();
						$req3 = $bdd->prepare('SELECT rel.id_membre_2 id_membre_2, rel.points_de_relation pdr, rel.t_sympathie t_s, rel.glacage glacage, rel.groupe_relationnel gr, rel.protection prot
						FROM inscrits AS ins RIGHT JOIN relations AS rel ON ins.id = rel.id_membre_2
...
<html>
	<head>
		...
		<title>Groupe des intrus - Les Nouveaux Arrivants</title>
	</head>
	<body>
			...
			<div class="pamais">
				...
				<div class="div2amais">
					<div class="div9cadre div10cadre taille">
						...
						<form method="post" action="traitement_gr.php" class="form">
							<div class="div2_gr">
								...
								<input type="hidden" name="gr" value=4 />
						...
						Aucun membre ne peut être une source de recommandations<br/>
						1/2/3 = Envoyer dans le groupe relationnel 1/2/3
					</div>
					<?php 
						if($relations == 1)
						{
							if($limitation == 0)
							{
								for($i = $o; $i <= $n; $i++)
								{
									if(isset($id_membre[$i]))
									{
										...
										<input type='submit' name='groupe_relationnel' value='1' class='boutonnom'/><br/>
							...
							}elseif($limitation == 1)
							{
								for($i = $o; $i <= $n; $i++)
								{
									if(isset($id_membre[$i]))
									{
										...
										<input type='submit' name='groupe_relationnel' value='3' class='boutonnom'/><br/>
										<label>Sympathie le " .$t_s. "</label>
										</form></div>";
									}
								}
					...
					<div class="div9cadre div10cadre div11cadre">
						<form method="post" action="groupe_des_intrus.php" class="form">
							<?php
